...
const requiredFiles = [
  ...
  'scripts/smoke-live-git-client.mjs',
...
for (const [file, labels] of [
  ...
  ['packages/forge-core/src/protected-write-policy.mjs', ['checkProtectedWritePolicy', 'enforceProtectedWritePolicy', 'parseReceivePackUpdates']],
