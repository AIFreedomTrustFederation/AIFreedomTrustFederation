...
| Offline collaboration | Yjs | Automerge, append-only records |
...
| Edge inference | llama.cpp-compatible local API | Transformers.js / ONNX runtime |
...
| Embeddings | Transformers.js / local model | Ollama-compatible embeddings, manual keyword index |
