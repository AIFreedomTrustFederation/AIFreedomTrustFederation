...
echo "🛠️ Repairing Phase 12A missing improve store"

mkdir -p packages/forge-core/src/improve
mkdir -p .forge/improvement/{scans,reports,proposals,metrics,architecture,history,patches,approvals,snapshots}
...
echo ""
echo "✅ Phase 12 repair complete."
echo ""
echo "Commit:"
echo "  git status"
echo "  git add ."
echo "  git commit -m \"Repair Phase 12 improvement store\""
