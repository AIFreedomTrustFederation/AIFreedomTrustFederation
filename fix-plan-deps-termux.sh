...
echo "🧠 Fixing plan-deps command for Termux"

mkdir -p packages/forge-core/src/commands

cat > packages/forge-core/src/commands/plan-deps.mjs <<'JS'
...
cat > packages/forge-core/src/commands/planDeps.mjs <<'JS'
...
echo "✅ plan-deps command files written."

echo ""
echo "Testing:"
aift-forge plan-deps
